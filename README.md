Descripción
-----------
Pequeño sitio que muestra habilidades en HTML, CSS y JavaScript. Tiene un diseño moderno con fondo hero, efecto glassmorphism y un modal de contacto con opciones para Gmail/Outlook/cliente de correo.
